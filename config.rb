...
the_hold_options = {
  ...
  :project => "musou", # 專案名稱, 會變成 http://your-project-name.evenwu.the-hold.handlino.com/
  #:project_site_password => "ghmusoudesign", # 密碼，這一行拿掉的話就沒有密碼
  :host => "http://the-hold.handlino.com/",
  :cname => "musou.evendesign.tw"
}